...
![CodeIgniter](https://img.shields.io/badge/CodeIgniter-FE7A16?style=for-the-badge&logo=codeigniter&logoColor=white)
...
- **Trigenius (Lisboa)**  
- Duração: **184 horas**  
- Funções: Integração de módulos ERP Primavera com C# e SQL Server, desenvolvimento de relatórios dinâmicos     e automação de processos de negócio.  
- Resultados: Consolidação de experiência prática em ERP, reporting e boas práticas de desenvolvimento.
...
- Desenvolver competências em análise de dados para transformar informação em insights de negócio
...
- [Email](mailto:sergio.web100@gmail.com)
